...
class TaskListCreateView(generics.ListCreateAPIView):
    ...
    def get_queryset(self):
        return Task.objects.select_related("project", "assigned_to", "created_by", "parent_task").prefetch_related(
            "labels", "subtasks", "comments", "time_entries"
        )
...
class TaskDetailView(generics.RetrieveUpdateDestroyAPIView):
    ...
    serializer_class = TaskSerializer
    queryset = Task.objects.select_related("project", "assigned_to", "created_by").prefetch_related(
        "labels", "subtasks", "comments", "time_entries"
    )
